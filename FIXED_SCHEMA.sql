-- FIXED Leave Management System Schema
...
-- Insert default leave types only if columns exist and table is empty
DO $$
BEGIN
  ...
  ELSE
    -- If no description column, insert basic data
...
SELECT 'Fixed Leave Management System schema created successfully!' as status;