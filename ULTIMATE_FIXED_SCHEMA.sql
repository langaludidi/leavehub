-- ULTIMATE FIXED Leave Management System Schema
-- This version handles the organizations foreign key constraint
...
SELECT 'Ultimate Fixed Leave Management System schema created successfully!' as status;