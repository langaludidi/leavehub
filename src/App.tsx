            ...
            <div className="space-y-4 sm:space-y-6">
              <div className="bg-white p-4 sm:p-6 lg:p-8 rounded-2xl shadow-lg border border-gray-100">
                <div className="flex flex-col space-y-3 sm:flex-row sm:items-center sm:justify-between sm:space-y-0 mb-4 sm:mb-6">
                  ...
                  <button onClick={handleViewComparison} className="bg-indigo-100 text-indigo-700 hover:bg-indigo-200 px-3 sm:px-4 py-2 rounded-lg text-xs sm:text-sm font-medium transition-all duration-200 flex items-center space-x-2 self-start sm:self-center">
                    <svg className="w-3 h-3 sm:w-4 sm:h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
                  ...
                  <div className="lg:col-span-2 p-4 sm:p-6 border border-green-200 rounded-xl bg-gradient-to-br from-green-50 to-emerald-50 hover:shadow-xl transition-all duration-300">
                    ...
                    <div className="flex items-center justify-between pt-4 border-t border-green-200">
                      ...
                      <button className="bg-green-600 text-white hover:bg-green-700 px-8 py-3 rounded-lg font-semibold transition-all duration-200 flex items-center space-x-2 shadow-lg hover:shadow-xl">
                ...
                <div className="mt-8 p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl border border-blue-200">
                  <div className="flex items-center justify-between">
                    ...
                    <button onClick={handleScheduleCall} className="bg-blue-600 text-white hover:bg-blue-700 px-6 py-3 rounded-lg font-semibold transition-all duration-200">
                      Schedule Call
                    </button>
                  </div>
                </div>
              ...
              <div className="bg-white p-6 rounded-2xl shadow-lg border border-gray-100">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <button onClick={handleFeatureComparison} className="bg-indigo-100 text-indigo-700 hover:bg-indigo-200 px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 flex items-center space-x-2">
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
