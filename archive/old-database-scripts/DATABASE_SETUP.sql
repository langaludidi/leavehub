...
-- Add computed column for available_days (not generated, just a view helper)
-- We'll calculate this in queries instead of using GENERATED ALWAYS
...
-- Leave types policies (everyone in company can view)
...
-- Function to restore leave balance (when request is cancelled/rejected)
